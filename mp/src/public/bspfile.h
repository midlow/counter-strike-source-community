...
#define MAX_MAP_TEXDATA_STRING_DATA		512000 //256000
#define MAX_MAP_TEXDATA_STRING_TABLE	131072 //65536
...
#define	MAX_KEY		64 //Bump maxiumum key length of key values in bsp to 64 (from 32)
